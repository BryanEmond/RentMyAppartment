...
CREATE TABLE user(UID char(100) NOT NULL, PRIMARY KEY(UID), first_name char(100), 
                    last_name char(100), middle_name char(100), PID char(12),  
...
CREATE TABLE City(CID char(100), region char (100), 
                arrondissement char (100), nombre_appt int,
                country_name char(12), 
...
INSERT INTO City('Quebec', 'Charlesbourg', 'Limoilou', 45, 'Canada');
INSERT INTO City('Montréal', 'Montréal-Nord', 'Cote-des-Neiges','Canada');
