...
CREATE TABLE appartments(AID char(12) NOT NULL,title char(100),appAddress char(100),zipCode char(100),town char(100),size char(10),price int, description text,coordinate char(20),UID char(12) not null,PRIMARY KEY(AID),FOREIGN KEY(UID) REFERENCES user(UID));